...
# Add parent directory to path to import bot_email
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from bot_email import get_news

# Configure logging
logging.basicConfig(level=logging.INFO)

def test_get_news():
    print("Testing get_news for 'ai' topic...")
    # This will trigger the real API/RSS calls and LLM summary
    # Ensure .env is loaded by bot_email import
